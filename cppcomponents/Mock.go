...
func (m Mock) Fields() map[string]string {
	...
	fields["{{Mock.Header.Includes}}"] = m.InheritedInterface.HeaderIncludesString
	fields["{{Mock.Implementation.Includes}}"] = m.InheritedInterface.ImplementationIncludesString
